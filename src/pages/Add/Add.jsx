    ...
    <div className=' w-[70%] ml-[max(5vw,25px)] mt-[50px] text-[#6d6d6d] text-[16px] '>
      <form className=' flex flex-col gap-[10px] ' onSubmit={onSubmitHandler}>
        ...
        <div className=' flex flex-col gap-[10px] w-[max(40%,280px)] '>
            ...
            <textarea onChange={onChangeHandler} value={data.description} name="description" rows="6" placeholder='Write content here' required className=' p-[10px]'></textarea>
        </div>
        <div className=' flex gap-[30px] '>
            <div className=' flex flex-col gap-[10px]'>
                <p>Product Category</p>
                <select onChange={onChangeHandler} name="category" className=' max-w-[120px] p-[10px]  '>
            ...
            <div>
                <p>Product Price</p>
                <input onChange={onChangeHandler} value={data.price} type="Number" name='price' placeholder='$20' className=' max-w-[120px] p-[10px]  ' />
            </div>
        </div>
